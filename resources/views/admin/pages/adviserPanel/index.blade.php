<x-admin-app-layout :title="'Adviser Panel'">
                ...
                <div class="row">
                    <div class="col-lg-9 col-sm-12 text-lg-center text-sm-center">
                        <div class="card-title table_title">
                            <h2 class="text-center text-white">Adviser Panel</h2>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-12 text-lg-end text-sm-center">
                        <button type="button" class="btn btn-sm btn-light-success rounded-0"
                            ...
                            data-bs-target="#adviserAddModal">
                            Add New
                        </button>
                    </div>
                </div>
                            ...
                            <tr class="odd">
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="#"
                                        ...
                                        data-bs-toggle="modal" data-bs-target="#adviserEditModal_{{ $team->id }}">
                                        <i class="fa-solid fa-pen"></i>
                                    </a>
                                    <a href="{{ route('admin.adviser-panel.destroy', $team->id) }}"
    ...
    {{-- Add Modal --}}
    {{-- Add Modal --}}
    <div class="modal fade" id="adviserAddModal" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content rounded-0 border-0 shadow-sm">
                <div class="modal-header p-2 rounded-0">
                    <h5 class="modal-title ps-5">Add Adviser Panel</h5>
                    <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal"
                        aria-label="Close">
                        <i class="fa-solid fa-circle-xmark"></i>
                    </div>
                </div>
                <form action="{{ route('admin.adviser-panel.store') }}" class="needs-validation" method="post"
    ...
    {{-- Edit Modal --}}
    @foreach ($teams as $team)
        <div class="modal fade" id="adviserEditModal_{{ $team->id }}" data-backdrop="static">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content rounded-0 border-0 shadow-sm">
                    <div class="modal-header p-2 rounded-0">
                        <h5 class="modal-title ps-5">Edit Adviser Panel</h5>
                        <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal"
                            aria-label="Close">
                            <i class="fa-solid fa-circle-xmark"></i>
                        </div>
                    </div>
                    <form action="{{ route('admin.adviser-panel.update', $team->id) }}" class="needs-validation"
