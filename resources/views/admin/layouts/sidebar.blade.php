        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion  {{ Route::is('admin.feature.index', 'admin.feature.create', 'admin.feature.edit', 'admin.success.index', 'admin.success.create', 'admin.success.edit', 'admin.row.index', 'admin.news-trend.index', 'admin.news-trend.create', 'admin.news-trend.edit', 'admin.homepage.index', 'admin.homepage.create', 'admin.homepage.edit', 'admin.whatwedo.index', 'admin.whatwedo.create', 'admin.whatwedo.edit', 'admin.learnmore.index', 'admin.learnmore.create', 'admin.learnmore.edit') ? 'here show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                    ...
                    <div
                        class="menu-sub menu-sub-accordion {{ Route::is('admin.feature.index', 'admin.feature.create', 'admin.feature.edit', 'admin.success.index', 'admin.success.create', 'admin.success.edit', 'admin.row.index', 'admin.news-trend.index', 'admin.news-trend.create', 'admin.news-trend.edit', 'admin.homepage.index', 'admin.homepage.create', 'admin.homepage.edit', 'admin.whatwedo.index', 'admin.whatwedo.create', 'admin.whatwedo.edit', 'admin.learnmore.index', 'admin.learnmore.create', 'admin.learnmore.edit') ? 'menu-active-bg' : '' }}">
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('admin.feature.index', 'admin.feature.create', 'admin.feature.edit') ? 'active' : '' }}"
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('admin.success.index', 'admin.success.create', 'admin.success.edit') ? 'active' : '' }}"
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('admin.news-trend.index','admin.news-trend.create','admin.news-trend.edit') ? 'active' : '' }}"
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('admin.whatwedo.index','admin.whatwedo.create','admin.whatwedo.edit') ? 'active' : '' }}"
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('admin.learnmore.index','admin.learnmore.create','admin.learnmore.edit') ? 'active' : '' }}"
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('admin.homepage.index','admin.homepage.create','admin.homepage.edit') ? 'active' : '' }}"
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('admin.about.index','admin.about.create','admin.about.edit') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{ Route::is('admin.contacts.index', 'admin.faq.index', 'admin.newsletters.index') ? 'here show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion mb-1 {{ Route::is('admin.adviser-panel.index', 'admin.executive-panel.index') ? 'here show' : '' }}">
                    <span class="menu-link">
                        <span class="menu-icon">
