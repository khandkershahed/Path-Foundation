...
class AdviserPanelController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'email'        => ['required', 'string', 'email', 'max:255', 'unique:adviser_panels,email'],
            'member_id'    => ['required', 'string', 'max:255', 'unique:adviser_panels,member_id'],
    ...
    public function update(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            'name'         => ['required', 'string', 'max:255'],
            'email'        => ['required', 'string', 'email', 'max:255', 'unique:adviser_panels,email,' . $id],
            'member_id'    => ['required', 'string', 'max:255', 'unique:adviser_panels,member_id,' . $id],
            'phone'        => ['nullable', 'string', 'regex:/^\+?[0-9]*$/'],
            'photo'        => ['nullable', 'file', 'image', 'mimes:jpeg,png,jpg,gif', 'max:2048'],
            'designation'  => ['nullable', 'string'],
            'institution'  => ['nullable', 'string'],
