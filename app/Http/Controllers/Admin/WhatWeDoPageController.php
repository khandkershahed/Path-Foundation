...
class WhatWeDoPageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.whatWeDoPage.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.pages.whatWeDoPage.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            if (isset($row_one_image)) {
                $globalFunRowOneImage = customUpload($row_one_image, $uploadPath, 320, 270);
            } else {
